        ...
        <div className="flex h-screen w-64 flex-col border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950">
            ...
            <div className="border-t border-slate-200 p-4 dark:border-slate-800">
                <div className="flex items-center gap-3">
                    <div className="h-9 w-9 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 font-bold">
                        A
                    </div>
                    <div className="text-sm">
                        <p className="font-medium">Admin BPJS</p>
                        <p className="text-xs text-slate-500">admin@bpjs.go.id</p>
                    </div>
                </div>
            </div>
        </div>
